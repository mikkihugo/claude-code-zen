...
description: 'Create specialized AI agents', type;
: 'object',
  'string',
enum: [
  'coordinator',
...
description: 'List active agents & capabilities', type;
: 'object',
'string', description
...
description: 'Auto-scale agent count', type;
: 'object',
...
description: 'Gracefully shutdown swarm', type;
: 'object',
type: 'boolean',
...
name: ' MEMORY & PERSISTENCE', description;
