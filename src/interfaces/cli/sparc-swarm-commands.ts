  ...
  sparcSwarmCmd
    ...
    .action(async (options) => {
      try {
        ...
        console.log(`  Average cycle time: ${Math.round(sparcMetrics.averageSparcCycleTime / 1000)}s`);
        ...
        console.log(`  Avg completion time: ${Math.round(workStatus.metrics.averageCompletionTime / 1000)}s`);
    ...
    .action(async (options) => {
      try {
        ...
        phases.forEach(phase => {
          ...
          console.log(`  Avg completion time: ${Math.round(phaseMetrics.averageCompletionTime / 1000)}s`);
        });
      ...
      try {
        ...
        const complexityExamples = {
          simple: {
            ...
            acceptance_criteria: ['Display user name', 'Show profile picture', 'Handle loading states']
          },
          moderate: {
        ...
        const demoTask: TaskDocumentEntity = {
          ...
          estimated_hours: options.complexity === 'complex' ? 40 : options.complexity === 'moderate' ? 16 : 8,
