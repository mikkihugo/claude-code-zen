...
export class ErrorContext {
  constructor(public operation: string, public metadata?: any) {}
}
...
export class WasmError extends Error {
  constructor(message: string, public wasmFunction?: string) {
    super(message);
    this.name = 'WasmError';
  }
}
...
export class ZenSwarmError extends Error {
  constructor(message: string, public swarmId?: string) {
    super(message);
