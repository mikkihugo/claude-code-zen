...
import type { SwarmPersistencePooled } from '../../../database/persistence/persistence-pooled.d.ts';
...
class ZenSwarmHooks {
  ...
  async initializePersistence() {
    try {
      ...
      const SwarmPersistencePooled = (await import('../../../database/persistence/persistence-pooled.js')).default;
  ...
  async preBashHook(args) {
    ...
    if (resources.requiresAgent && resources.agentType) {
  ...
  estimateCommandResources(command: string): { duration: number; requiresAgent: boolean; agentType?: string } {
    const resourceMap = {
