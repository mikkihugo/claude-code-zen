 ...
 * @param {boolean} options.sparc - Whether to
include;
SPARC;
templates
 * @param {boolean}
options.enhanced - Whether;
to;
use;
enhanced;
templates
 * @param {boolean}
options.minimal - Whether;
to;
use;
minimal;
templates
 * @param {boolean}
options.optimized - Whether;
to;
use;
optimized;
templates
 * @param {boolean}
options.dryRun - Whether;
to;
perform;
a;
dry;
run
 * @param {boolean}
options.force - Whether;
to;
overwrite;
existing;
files
 * @param {string[]}
options.selectedModes - Selected;
SPARC;
modes;
to;
copy
