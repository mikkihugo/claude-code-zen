...
console.warn('Step 1: Setting up Claude configuration');
try {
...
console.warn('Step 2: Testing Claude CLI availability');
try {
  ...
  console.warn('1. Download from: https://claude.ai/code');
  console.warn('2. Run: curl -sSL https://claude.ai/install.sh | bash');
...
console.warn('# Create and expand tasks');
...
console.warn('Step 4: Creating example task');
const exampleTask = {
  id: 'example-001',
